...
2. **Ontology data locations**:
   - `data/transformed/ontologies/` — nodes/edges for GO, CHEBI, EC, and METPO
   - `data/transformed/rhea_mappings/` — RHEA reaction mappings (use for RHEA nodes/edges)
...
- **Ontology data**:
  - `data/transformed/ontologies/` (GO, CHEBI, EC, METPO)
  - `data/transformed/rhea_mappings/` (RHEA via rhea_mappings transform)
