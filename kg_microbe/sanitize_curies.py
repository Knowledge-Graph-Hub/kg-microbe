...
@click.option('--nodes-fixed', required=True, type=click.Path(), help="Output sanitized nodes TSV file (should end with _nodes.tsv)")
@click.option('--edges-fixed', required=True, type=click.Path(), help="Output sanitized edges TSV file (should end with _edges.tsv)")
