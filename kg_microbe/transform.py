...
#from kg_microbe.transform_utils.chembl.chembl_transform import ChemblTransform
from kg_microbe.transform_utils.drug_central.drug_central import DrugCentralTransform
#from kg_microbe.transform_utils.gocam_transform.gocam_transform import GocamTransform
...
from kg_microbe.transform_utils.fierer.fierer import FiererDataTransform
...
DATA_SOURCES = {
    ...
    'FiererDataTransform': FiererDataTransform
}
