                    ...
                    if temp_opt_bin:
                        ...
                        edge_writer.write_row(
                            [
                                ...
                                curie,
                                self._get_relation_for_predicate(temp_opt_bin["predicate"]),
                                self.knowledge_source,
                                OBSERVATION,
                                AUTOMATED_AGENT,
                                100.0,
                    ...
                    if nacl_opt_bin:
                        ...
                        edge_writer.write_row(
                            [
                                ...
                                curie,
                                self._get_relation_for_predicate(nacl_opt_bin["predicate"]),
                                self.knowledge_source,
                                OBSERVATION,
                                AUTOMATED_AGENT,
                                100.0,
                    ...
                    if ph_opt_bin:
                        ...
                        edge_writer.write_row(
                            [
                                ...
                                curie,
                                self._get_relation_for_predicate(ph_opt_bin["predicate"]),
                                self.knowledge_source,
                                OBSERVATION,
                                AUTOMATED_AGENT,
                                100.0,
                    ...
                    for phenotype in temp_phenotypes:
                        ...
                        edge_writer.write_row(
                            [
                                ...
                                phenotype["predicate"],
                                curie,
                                self._get_relation_for_predicate(phenotype["predicate"]),
                                self.knowledge_source,
                                OBSERVATION,
                                AUTOMATED_AGENT,
                                100.0,
