    ...
    def run(
        ...
        if not input_file.exists():
            logger.warning(
                ...
                "Download from https://metatraits.embl.de/ or contact antheaguo@berkeley.edu for access."
            )
        ...
        with (
            ...
            for row in progress_iter:
                ...
                predicate = (
                    row.get(METATRAITS_PREDICATE_COLUMN, "").strip() or HAS_PHENOTYPE_PREDICATE
                )
                ...
                edge_row[self.edge_header.index(PRIMARY_KNOWLEDGE_SOURCE_COLUMN)] = (
