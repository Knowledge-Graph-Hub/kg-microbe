...
from kg_microbe.transform_utils.constants import (
    ...
    UNIPROT_FUNCTIONAL_MICROBES_TMP_DIR,
    UNIPROT_FUNCTIONAL_MICROBES_TMP_NE_DIR,
...
OBSOLETE_TERMS_CSV_FILE = UNIPROT_FUNCTIONAL_MICROBES_TMP_DIR / "go_obsolete_terms.tsv"
...
class UniprotFunctionalMicrobesTransform(Transform):
    ...
    def __init__(self, input_dir: Optional[Path] = None, output_dir: Optional[Path] = None):
        ...
        """
        source_name = UNIPROT_FUNCTIONAL_MICROBES
    ...
    def run(self, data_file: Union[Optional[Path], Optional[str]] = None, show_status: bool = True):
        ...
        os.makedirs(UNIPROT_FUNCTIONAL_MICROBES_TMP_DIR, exist_ok=True)
        os.makedirs(UNIPROT_FUNCTIONAL_MICROBES_TMP_NE_DIR, exist_ok=True)
