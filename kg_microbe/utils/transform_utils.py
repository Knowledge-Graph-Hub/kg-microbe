...
def multi_page_table_to_list(multi_page_table: Any) -> List[Dict]:
    ...
    :return table_data: A list of dicts, where each dict is item from one row.
    """
...
def get_header_items(table_data: Any) -> List:
    ...
    :return header_items: An array of header items.
    """
...
def parse_header(header_string: str, sep: str = '\t') -> List:
    ...
    :param header_string: A string containing header items.
...
def guess_bl_category(identifier: str) -> str:
    ...
    :param identifier: A CURIE
    :return: The category for the given CURIE
    """
