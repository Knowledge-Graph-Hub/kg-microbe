...
summary = {
 'scope': 'Observed references in all existing data/transformed/**/*edges.tsv to the 476 identifiers missing from candidate-v2; includes gitignored files. This is exposure, not predicted deletion or a post-promotion graph validation. Producers have not been rebuilt.',
