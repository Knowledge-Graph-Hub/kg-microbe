...
These constants override the default biolink:located_in / biolink:consumes /
biolink:capable_of with METPO-specific domain-predicates. If anyone reverts
them, the test fails and the regression is caught before downstream queries
break.
"""
...
METPO_OVERRIDE_EXPECTATIONS = {
    "NCBI_TO_MEDIUM_EDGE": "METPO:2000517",
