...
class TestTraits(unittest.TestCase):
    ...
    def setUp(self) -> None:
        ...
        self.traits = TraitsTransform(input_dir=self.input_dir, output_dir=self.output_dir)
    ...
    @unittest.skip("Not currently working due to OGRE path setup.")
    def test_run(self):
    ...
    def test_edges_file(self, *args):
        ...
        self.assertEqual(["subject", "predicate", "object", "relation"], list(edge_df.columns))
